...
function Footer() {
  const newLocal =
    "flex items-center gap-2 shrink-0 bg-white border-2 border-black p-2 rounded-xl shadow-[3px_3px_0px_#006644] rotate-[-1deg]";
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          <div className="flex flex-col gap-3 items-start">
            ...
            <Link
              to="/home"
              className="hover:text-[#FF5F1F] font-bold text-sm uppercase tracking-wide transition-colors"
            >
              Início
            </Link>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 text-xs text-center lg:text-left">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className={newLocal}>
              <h1 className="text-3xl font-black tracking-tighter italic leading-none uppercase">
            ...
            <p className="leading-relaxed text-gray-400 font-medium max-w-md">
              © Copyright {new Date().getFullYear()} - VittaRun - Todos os
              direitos reservados.
              <br />
              Projeto Acadêmico Integrador desenvolvido para o Bootcamp da
              Generation Brasil.
              <br />
              VittaRun | Agência de Restaurantes Online S.A. • CNPJ
              12.345.678/0001-90
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center lg:justify-end gap-x-6 gap-y-3 max-w-md">
            <a
              href="#"
              className="hover:text-[#FFC700] font-bold uppercase tracking-wider transition-colors"
            >
              Termos e condições
            </a>
